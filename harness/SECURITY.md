...
Reset: `harness-ctl breaker reset awsysco-ts-sdk`
...
`"vault: scope <scope> not granted to agent awsysco-ts-sdk"`
...
Query: `harness-ctl audit awsysco-ts-sdk`
Or: `GET http://127.0.0.1:7700/harness/audit?agent=awsysco-ts-sdk`
